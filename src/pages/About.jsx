...
const About = () => {
  return (
    <div id='about' className='flex flex-col justify-center items-center min-h-screen bg-blue-950 py-10'>
      <div className='flex flex-col items-start bg-white max-w-full sm:w-[800px] md:w-[1000px] lg:w-[1200px] p-6 rounded-xl gap-10'>
        <h2 className='text-center text-4xl text-slate-600 font-bold mb-6 sm:text-3xl'>
          About Me
        </h2>
        ...
        <p className='text-slate-600 text-xl sm:text-lg'>
        ...
        <div className='flex flex-col gap-4'>
          <div className='flex items-center gap-3'>
            ...
            <p className='text-slate-700 text-xl sm:text-lg'>Frontend Development with React.js</p>
          </div>

          <div className='flex items-center gap-3'>
            <FiCheckSquare className='text-orange-600' />
            <p className='text-slate-700 text-xl sm:text-lg'>Backend Development with Node.js & Express</p>
          </div>

          <div className='flex items-center gap-3'>
            <FiCheckSquare className='text-orange-600' />
            <p className='text-slate-700 text-xl sm:text-lg'>Database Management with MongoDB</p>
          </div>
        </div>
      </div>
    </div>
